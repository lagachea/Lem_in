...
/*   Updated: 2020/05/09 13:02:39 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lem_in.h"

static	t_list	*search_room(t_lem_in *info, char *room)
{
	t_list *ptr;
...
static	int		get_link(t_lem_in *info, char *room_name1, char *room_name2)
{
	t_list *ptr1;
	t_list *ptr2;
	t_room *room1;
