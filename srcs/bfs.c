...
/*   Updated: 2020/05/09 13:07:25 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	add_to_front(t_room *to_add, t_room **queue)
{
...
static	int		set_levels(t_room *front_ptr, t_room **next_f, int levels,
					t_lem_in *lem_in)
{
	t_list	*neigh_ptr;
...
static	int		set_frontier(t_room *frontier,
	t_lem_in *lem_in, t_room **next_f, int levels)
{
	t_room	*front_ptr;
	int		ret;
