...
/*   Updated: 2020/05/09 12:58:43 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	equilibrate_ants(int *ants, int flow, t_path *paths)
{
	int	i;
	int	j;
...
static	void	fill_rest(int *ants, int flow, t_path *paths)
{
	int	nb;
	int	i;
