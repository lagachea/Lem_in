...
/*   Updated: 2020/05/09 13:06:54 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		get_path(char **matrice,
	t_list *start, t_list *neigh, t_list **path)
{
	t_list *ptr;
...
static	void	remove_flow(t_list **path, char **matrice)
{
	t_list *ptr;
...
static	int		add_paths(char **matrice,
	t_path *paths, t_list *start, int flow)
{
	t_list	*neigh;
	int		i;
...
static	void	re_add_flow(t_path *paths, int flow, char **matrice)
{
	t_list	*ptr;
	int		i;
