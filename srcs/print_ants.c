...
/*   Updated: 2020/05/09 13:07:45 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int8_t	ants_to_move(t_path *paths, int flow)
{
	int	i;
...
static	int8_t	move_ant(t_room *dst, t_room *src, int *space)
{
...
static	int8_t	move_new_ant(t_path *path,
	t_room *room, int *next_ant, int *space)
{
...
static	int8_t	move_path(t_path *path, int *next_ant, int move)
{
	t_list	*ptr;
