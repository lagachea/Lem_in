...
/*   Updated: 2020/05/09 12:48:31 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		has_collision(t_path *little, t_path *big)
{
	t_list *ptr_little;
	t_list *ptr_big;
...
static	int		remove_collision(t_path *paths, int flow)
{
	int	i;
	int	j;
	int	len;
...
static	void	copy_paths(t_path *new, t_path *old, int old_len)
{
	int	n;
	int	o;
