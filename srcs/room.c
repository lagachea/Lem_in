...
/*   Updated: 2020/05/09 12:57:17 by plagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int	mv_to_next_room(t_lem_in *info)
{
...
static	int	fill_room(t_list *new, char *line)
{
	char	*ptr;
	size_t	len;
...
static	int	get_room_info(t_lem_in *info)
{
